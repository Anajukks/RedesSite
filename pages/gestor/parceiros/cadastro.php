...
<body>
    <div class="containerAll">
        <h1 id="titulo">Adicionar parceiro</h1>
        <form action="/parceiros/store" method="post" id="formulario">
            ...
            <div class="input-group mb-3 area">
                ...
                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="function">
            </div>
